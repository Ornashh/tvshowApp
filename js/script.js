const popularShowUrl = "https://api.themoviedb.org/3/discover/tv?api_key=39008b197a5755859d6786a809d485be&language=en-US&sort_by=popularity.desc&page=1";
const imgUrl = 'http://image.tmdb.org/t/p/w1280';
const searchUrl = 'https://api.themoviedb.org/3/search/tv?api_key=39008b197a5755859d6786a809d485be&language=en-US&page=1&query=';
        ...
        modalInnerEl.innerHTML = `
            ...
            <div class="modal-text">
                <div class="name">
                    ...
                    <h2>
                        ${tvShow.name}
                        <div class="year">(${tvShow.first_air_date.slice(0,4)})</div>
                    </h2>
                </div>
                <div class="overview">
                    ${tvShow.overview}
